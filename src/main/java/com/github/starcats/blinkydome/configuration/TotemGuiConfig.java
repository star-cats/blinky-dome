...
/**
 * LXStudio-based (GUI, not headless) configuration for the {@link TotemModel} model
 */
public class TotemGuiConfig extends TotemConfig implements StarcatsLxGuiConfig<TotemModel> {

  public TotemGuiConfig(PApplet p) {
    super(p);
  }
