...
/**
 * LXStudio-based (GUI, not headless) configuration for the {@link LettersModel} model
 */
public class LettersDANNAGuiConfig extends LettersDANNAConfig implements StarcatsLxGuiConfig<LettersModel> {

  private P3LX p3lx;
  private LXStudio.UI ui;

  public LettersDANNAGuiConfig(PApplet p) {
    super(p);
  }
