...
import com.github.starcats.blinkydome.model.danna_letters.LettersModel;
...
/**
 * Headless configuration for the {@link LettersModel} model
 */
public class LettersDANNAConfig extends AbstractStarcatsLxConfig<LettersModel> {
  ...
  public LettersDANNAConfig(PApplet p) {
    super(p);
  }

  @Override
  protected LettersModel makeModel() {
    return LettersModel.makeDANNA();
  }
  ...
  @Override
  protected void initComponents(PApplet p, LX lx, LettersModel model) {
...
//    }
  ...
  @Override
  protected List<LXModulator> constructModulators(PApplet p, LX lx, LettersModel model) {
...
//        new FadecandyOutput(lx, "localhost", 7890),
  ...
  private List<LXPattern> makeMasks() {
    ...
    LX.LXPatternFactory<Mask_PerlinLineTranslator> perlinLineTranslatorFactory =
        (lx2, ch, l) -> new Mask_PerlinLineTranslator(lx, p, model.letters);
    ...
    LX.LXPatternFactory<Mask_RandomFixtureSelector> rfsFactory =
        (lx2, ch, l) -> new Mask_RandomFixtureSelector(lx2, model.letters);
    ...
    LX.LXPatternFactory<Mask_FixtureDottedLine> fdlFactory =
        (lx2, ch, l) -> new Mask_FixtureDottedLine(lx2, model.letters);
    lx.registerPatternFactory(Mask_FixtureDottedLine.class, fdlFactory);


    LX.LXPatternFactory<Mask_AngleSweep> angleSweepFactory =
        (lx2, ch, l) -> new Mask_AngleSweep(lx2, new PVector(1, 0, 0), model.letters, lx.tempo);
  ...
  /** Creates standard set of LettersModel patterns */
  private List<LXPattern> makeStandardPatterns() {
    ...
    LX.LXPatternFactory<FixtureColorBarsPattern> fcbpFactory =
        (lx2, channel, label) -> new FixtureColorBarsPattern(lx2, model.letters, colorMappingSources);
    ...
    // PerlinNoisePattern: apply defaults appropriate for LettersModel mapping size
    // --------------------
