...
public class DloCommuterBikeModel extends LXModel {
  ...
  public static DloCommuterBikeModel makeModel(boolean hasGui) {
...
//    }
    ...
    return new DloCommuterBikeModel(allFixtures, framePieces, brakeBlob, hasGui);
  }

  private DloCommuterBikeModel(List<LXFixture> allFixtures, List<LXFixture> framePieces, LXFixture brakeBlob, boolean hasGui) {
    super(allFixtures.toArray(new LXFixture[allFixtures.size()]));

    System.out.println("Starting up with DloCommuterBikeModel model");
